...
\subsection{Stetigkeit}
  ...
  \definition{3.2.5}{Konvergenz einer Funktion}
    $f:U\rightarrow\mathbb R^m$ konvergiert bei $x_0\in U$ gegen $y\in\mathbb
...
\proposition{3.4.4}{Eigenschaften von differenzierbaren Funktionen}
  Wenn \(U\in\mathbb R^n\) eine offene Menge, \(f:U\rightarrow \mathbb R^m\) eine differenzierbare Funktion dann gilt:
  \begin{enumerate}
...
\rmrk{}{Richtungsableitung \(D_{e_i}f(x_0)\)}
  Eine Richtungsableitung stellt eine Verallgemeinerung der partiellen Ableitungen dar, denn \(\partial_i f(x_0)=D_{e_i}f(x_0)\), wobei \(e_i\in\mathbb R^n\) den \(i\)-ten Standardbasisvektor bezeichnet.
